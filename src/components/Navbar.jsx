  ...
  return (
    ...
    <div className=' flex items-center  justify-between px-5 py-3 shadow-md lg:fixed top-0 right-0 left-0 z-30 bg-white'>
        ...
        <div className="block md:hidden duration-300 ease-linear" onClick={handletoggle}>
          { toggle ? <AiOutlineClose className='text-[30px] z-50  '/> : <AiOutlineMenu className='text-[30px] z-50  '/> }
        </div>

    </div>
    { toggle && <ul className='flex-col bg-gray-50 duration-300 sticky top-0    ease-linear flex justify-center font-bold items-center w-full z-10 '>
            <a href="#apropos" className='border-b-2 py-2 mb-2 w-full text-center'><li className=' '>À propos</li></a>
            <a href="#metiers" className='border-b-2 py-2 mb-2 w-full text-center'><li className=' '>Nos métiers</li></a>
            <a href="#moyenss" className='border-b-2 py-2 mb-2 w-full text-center'><li className=' '>Nos moyens</li></a>
            <a href="#certificats" className='border-b-2 py-2 mb-2 w-full text-center'><li className=' '>Certificats</li></a>
            <a href="#agrement" className='border-b-2 py-2 mb-2 w-full text-center'><li className=' '>Agréments</li></a>
            <a href="#contact" className='border-b-2 py-2 mb-2 w-full text-center'><li className=' '>Nous Contacter</li></a>
            <a href="#" className='rounded-full bg-mainblue text-white px-5 py-3'><li className='flex items-center '><FaUserCircle className='mr-1 text-xl'/> Espace Client</li></a>
        </ul>}
    </>
  )
